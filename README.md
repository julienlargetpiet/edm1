...
eturns the number of row that contains vectors (multiple in a list), coeff and strt_l may vary 
istinct is the value you are sure is not contained in the matrix 
